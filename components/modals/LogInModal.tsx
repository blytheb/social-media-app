...
export default function LogInModal() {
	...
	return (
		<>
			<button
				className=" w-full h-[48px] md:w-[88px] md:h-[40px] text-md md:text-sm border-2 border-gray-100 rounded-full
				...
				<div className="w-full h-full sm:w-[600px] sm:h-fit bg-white sm:rounded-xl outline-none">
					...
					<div className="pt-10 pb-20 px-4 sm:px-20">
						...
						<div className="w-full space-y-5 mb-10">
							<input
								type="email"
								className="w-full h-[54px] border border-gray-200 outline-none ps-3 rounded-[4px]
								focus:border-[#F4AF01]
								transition"
								placeholder="Email"
							...
							<div
								...
								<div
									...
									className="w-7 h7 text-gray-400 cursor-pointer">
